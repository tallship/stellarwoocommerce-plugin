...
function wc_stellar_gateway_init() {
	...
	class WC_Gateway_Stellar extends WC_Payment_Gateway {
		...
		public function __construct() {
			...
			$this->method_title       = __( 'Stellar', 'wc-gateway-stellar' );
			$this->method_description = __( 'Pay with Stellar.', 'wc-gateway-stellar' );
		...
		public function init_form_fields() {
			...
			$this->form_fields = apply_filters( 'wc_offline_form_fields', array(
				...
				'enabled' => array(
					...
					'type'    => 'checkbox',
					'label'   => __( 'Enable Stellar Payment', 'wc-gateway-stellar' ),
					'default' => 'yes'
				),
				...
				'title' => array(
					...
					'type'        => 'text',
					'description' => __( 'Stellar', 'wc-gateway-stellar' ),
					'default'     => __( 'Stellar', 'wc-gateway-stellar' ),
					'desc_tip'    => true,
				),
				...
				'description' => array(
					...
					'type'        => 'textarea',
					'description' => __( 'Pay with Stellar', 'wc-gateway-stellar' ),
					'default'     => __( 'Pay with Stellar', 'wc-gateway-stellar' ),
					'desc_tip'    => true,
				),
